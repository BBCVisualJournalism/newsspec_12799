    ...
    if (worksheets !== undefined) {
        grunt.config(['cloudfile_to_vocab', 'default'], {
            options: {
                ...
                whitelisted_services:  ['afrique', 'arabic', 'azeri', 'bengali', 'brasil', 'burmese', 'chinese_simp', 'chinese_trad', 'cymru', 'english', 'french', 'gahuza', 'hausa', 'hindi', 'indonesia', 'kyrgyz', 'mundo', 'nepali', 'pashto', 'persian', 'portuguese', 'russian', 'sinhala', 'somali', 'swahili', 'tamil', 'turkish', 'ukrainian', 'urdu' , 'uzbek', 'vietnamese']
            }
        });
    }
