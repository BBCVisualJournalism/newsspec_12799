define(['http://maps.google.com/maps/api/js', 'maps/defaultStyles', 'maps/textLabelTypes', 'maps/markerTypes', 'maps/bbcSettings', 'maps/markers', 'maps/BBCMap', 'maps/BBCLabelOverlay', 'maps/BBCCircleOverlay', 'maps/toll'],
        ...
        var map1 = new BBCMap(
                {
                    ...
                    'kmlLayers': [
                        ...
                        'https://dl.dropboxusercontent.com/u/7667577/test_greece_turkey_boundary.kml'
                    ],
                    'markers': markers,
